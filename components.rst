...
Please refer to :ref:`ClusterControl UI` for the functionalities available in the ClusterControl UI.
...
For more details on the usage, see :ref:`ClusterControl CLI`.